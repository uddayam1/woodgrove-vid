...
namespace WoodgroveDemo.Controllers.Presentation;
...
public class IssueController : ControllerBase
{
    ...
    public IssueController(TelemetryClient telemetry, IConfiguration configuration, IMemoryCache cache, IHttpClientFactory httpClientFactory)
    {
        ...
        _Settings = new Settings(configuration, "Presentation", false);
    }

    [AllowAnonymous]
    [HttpPost("/api/Presentation/Issue")]
    public async Task<ResponseToClient> Post()
    {
        ...
        Status status = new Status("Presentation", "Issue");
